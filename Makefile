...
choh_colour: choh_colour.cpp lodepng.cpp platform.h rans_byte.h symbolstats.hpp file_io.hpp filter_utils.hpp filters.hpp varint.hpp panic.hpp table_encode.hpp
	g++ -o $@ $< lodepng.cpp -O3 $(LIBS)
