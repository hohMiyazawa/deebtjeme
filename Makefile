...
choh: choh.cpp platform.h rans_byte.h symbolstats.hpp file_io.hpp filter_utils.hpp filters.hpp varint.hpp panic.hpp numerics.hpp laplace.hpp lode_io.hpp bitwriter.hpp
	g++ lodepng.cpp -o $@ $< -O3 $(LIBS)
